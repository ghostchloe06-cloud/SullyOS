...
const CreatorPartsUploader: React.FC<{ onClose: () => void }> = ({ onClose }) => {
    ...
    return (
        <div className="fixed inset-0 z-[65] flex flex-col" style={{ background: 'linear-gradient(180deg, #241b3f 0%, #171130 55%, #120d24 100%)' }}>
            {/* 顶栏 */}
            <div className="shrink-0 px-4 pb-3 flex items-center gap-2 text-white" style={{ paddingTop: 'var(--safe-top)' }}>
            ...
            <div className="flex-1 overflow-y-auto no-scrollbar px-4 pb-10 space-y-4">
                {/* PSD 导入卡 */}
